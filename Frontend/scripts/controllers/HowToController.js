...
app.controller('HowToController', 
	['$scope', '$q', '$location', 'authenticationService', 'articleService', function ($scope, $q, $location, authenticationService, articleService) {
		...
		requestQueue.push(articleService.getAllCategories().then(function (response) {
